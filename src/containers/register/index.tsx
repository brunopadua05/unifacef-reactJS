        ...
        <Form>
          <Form.Group widths='equal'>
            <Form.Field>
              ...
              <input value={zipcode || ''} maxLength={8} name='zipcode' onChange={handleForm} placeholder='Ex 14400123' />
            </Form.Field>
            <Form.Field>
              <Cep zipCode={zipcode} />
            </Form.Field>
          ...
          <Form.Group widths='equal'>
            <Form.Field>
              ...
              <input value={github || ''} maxLength={100} name='github' onChange={handleForm} placeholder='Ex brunopadua05' />
            </Form.Field>
            <Form.Field>
